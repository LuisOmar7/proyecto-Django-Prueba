# Generated by Django 5.0.6 on 2025-02-04 19:07
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('carrera', models.CharField(choices=[('TI', 'Tecnologías de la Información'), ('BIO', 'Biología')], max_length=50)),
        ...
        migrations.AddField(
            model_name='alumnos',
            name='formacion',
            field=models.ManyToManyField(to='registros.formacion'),
        ),
        migrations.CreateModel(
            name='Profile',
            fields=[
